...
int32_t its_msg_processor_cm_init() {
    ...
    m_bIsDoingGeneralStatusUpdate = true;
...
int32_t its_msg_processor_cm_process_rx_cam(CAM *psCam, SITSStationFusionData *psLocalStationData, SITSStationFusionData *psRemoteStationData) {
    ...
    if(GN_ITS_STATION_ROAD_SIDE_UNIT == psRemoteStationData->m_n32StationType) {
        ...
        if(false == m_bIsDoingGeneralStatusUpdate) {
            ...
            // TODO Remove this.
            psCam->cam.camParameters.highFrequencyContainer.u.basicVehicleContainerHighFrequency.heading.headingValue = g_sLocalStationInfo.m_sVehicleInfo.m_n32VehicleWeight;
            psCam->cam.camParameters.highFrequencyContainer.u.basicVehicleContainerHighFrequency.heading.headingConfidence = g_sLocalStationInfo.m_sVehicleInfo.m_n32VehicleHeight;
